...
function getPages(routeStr) {
  ...
  if (pageNum == 1) {
    ...
    for (j = 1; j < pagesNum && j < 5; j++) {
      pagesHtml = pagesHtml.concat('<a href="/recipes_' + routeStr + '_' + (j + 1) + '">0' + (j + 1) + '</a>'); //pagesHtml = pagesHtml.concat('<a href="/recipes_'+routeStr+'_2">0'+(j+1)+'</a>');
    }
...
/***/ 5:
/*!********************************************!*\
  !*** multi ./resources/js/main-recipes.js ***!
  \********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\xstart\Laravel\food-project5\resources\js\main-recipes.js */"./resources/js/main-recipes.js");
