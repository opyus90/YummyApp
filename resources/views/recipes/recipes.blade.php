...
<body>
    ...
    <section class="recipe-section spad">
        <div class="container">
            ...
            @foreach ( $recipes as $recipe )
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="recipe-item">
                        <a href="/recipe_{{ $recipe }}"><img src="img/recipes/{{ $recipe }}.jpg" alt=""></a>
                        <div class="ri-text">
                            <div class="cat-name">{{ $categories[$count-1] }}</div>
                            <a href="/recipe_{{ $recipe }}">
                                <h4>{{ $recipes[$count-1] }}</h4>
                            </a>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="recipe-pagination" pageN="{{ $page }}" pagesN="{{ $numPages }}" key="{{ $key }}" string="{{ $string }}">
					  <ul class="pages">
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
	...
	<script src="{{ asset('js/main-recipes.js') }}"></script> 
</body>
